...
export class CupcakeListDataService {
  constructor() {}
  ...
  cupcakeList = [
    ...
    },
    {
      ...
      taste: 'Blue Curacao, blueberries, buttery cream, and a hint of vanilla.',
      stars: 4.3,
  ...
  constructComment(comment: string, index: number) {
    this.cupcakeList[index].reviews.push({
      name: 'Mikey',
      text: comment,
    });
  }
